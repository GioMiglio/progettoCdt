            ...
            <body>
                ...
                <div id="bottoni">
                   ...
                   <p>Clicca sui bottoni ed evidenzia gli elementi di codifica che più ti interessano</p>
                        ...
                        <button id="distinct_arc" class="red">Arcaicismi</button>
                        ...
                        <button id="literary_usage" class="Blue">Termini letterari</button>
                     ...
                     <div class="all">
                          ...
                          <xsl:apply-templates select="//tei:text[@xml:id='Notizie']"/>                      
                           ...
                           <div id="img_notizie" class="image">
                            <xsl:apply-templates select="//tei:surface[@xml:id='pagina68']"/> 
                           </div>
                     </div>    
                </div>
...
<xsl:template match="tei:titleStmt/tei:funder">
  <xsl:for-each select="tei:persName">
    ...
    <xsl:template match="tei:sourceDesc">
        ...
        <p><b>Titolo: </b><xsl:value-of select="tei:biblStruct/tei:monogr/tei:title[@type='main']"/> <xsl:value-of select="tei:biblStruct/tei:monogr/tei:title[@type='sub']"/><br />
 ...
 <xsl:template match="tei:analytic">
    ...
    <xsl:for-each select="tei:biblScope">
       ...
       <p><b>Data di pubblicazione:</b><br /><xsl:value-of select="."/></p>
       </xsl:if>
...
<xsl:template match="tei:distinct[@type='archaic']">
        <xsl:element name="span">
            <xsl:attribute name="class">distinct_arc</xsl:attribute>
            <xsl:apply-templates />
        </xsl:element>
</xsl:template>
